...
def get_groq_response(sender_id, message):
    ...
    # --- পরিবর্তন: AI-কে এখন সম্পূর্ণ মেন্যু এবং পলিসি দেওয়া হচ্ছে ---
    KNOWLEDGE_BASE_FOR_AI = f"""
    {FULL_MENU_TEXT}

    ## পলিসি এবং অন্যান্য তথ্য
    - **অর্ডার প্রসেসিং সময়:** অর্ডার কনফার্ম হওয়ার পর ২৪ থেকে ৭২ ঘণ্টার মধ্যে ডেলিভারি করা হয়।
    - **ডেলিভারি এলাকা:** আমরা ঢাকার প্রায় সব এলাকায় ডেলিভারি করি।
    ...
    1.  সর্বদা গুছিয়ে, সুন্দর এবং শুদ্ধ বাংলায় উত্তর দিন।
    2.  যদি গ্রাহক একাধিক আইটেমের পরিমাণ উল্লেখ করে মোট দাম জানতে চায়, তাহলে অবশ্যই মেন্যু থেকে দাম নিয়ে হিসাব করে একটি ব্রেকডাউন সহ মোট মূল্য দেখাবেন। ডেলিভারি চার্জ যোগ করতে বললে সেটাও যোগ করবেন।
    3.  (এখানে আপনার আগের অন্যান্য নির্দেশনাগুলো থাকবে)
    
    ### কথোপকথনের উদাহরণ (Conversation Examples) ###
    (এখানে আপনার আগের উদাহরণগুলো থাকবে)
    ---
    **স্যাম্পল ৪ (নতুন): 계산ের উদাহরণ**
    user: "২ প্যাকেট চিকেন রোল আর ১ প্যাকেট আটা রুটির দাম চার্জ সহ মোট কত আসবে?"
    bot: "অবশ্যই, স্যার/ম্যাম! আমি হিসাব করে দিচ্ছি:\n- চিকেন রোল (২ প্যাকেট): ২২৫ x ২ = ৪৫০ টাকা\n- আটা রুটি (১ প্যাকেট): ১৬০ x ১ = ১৬০ টাকা\n- ডেলিভারি চার্জ: ৬০ টাকা\n\nসর্বমোট: ৪৫০ + ১৬০ + ৬০ = ৬৭০ টাকা। 😊"
    ---
